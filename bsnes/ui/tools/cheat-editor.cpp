...
CheatEditor::CheatEditor() {
  ...
  append(layout);
  layout.setMargin(5);
  layout.append(cheatList,               {  static_cast<unsigned int>(~0), static_cast<unsigned int>(~0) }, 5);
  layout.append(codeLayout,              {  static_cast<unsigned int>(~0),  0 }, 5);
    codeLayout.append(codeLabel,         {  80,  0 }, 0);
    codeLayout.append(codeEdit,          {  static_cast<unsigned int>(~0),  0 }, 0);
  layout.append(descLayout,              {  static_cast<unsigned int>(~0),  0 }, 5);
    descLayout.append(descLabel,         {  80,  0 }, 0);
    descLayout.append(descEdit,          {  static_cast<unsigned int>(~0),  0 }, 0);
  layout.append(controlLayout,           {  static_cast<unsigned int>(~0),  0 }, 0);
