...
SlotLoaderPath::SlotLoaderPath() {
  ...
  append(label,  { 40, 0 }, 5);
  append(path,   { static_cast<unsigned int>(~0), 0 }, 5);
...
SlotLoader::SlotLoader() {
  ...
  append(layout);
  layout.append(base,                { static_cast<unsigned int>(~0), 0 }, 5);
  layout.append(slot[0],             { static_cast<unsigned int>(~0), 0 }, 5);
  layout.append(slot[1],             { static_cast<unsigned int>(~0), 0 }, 5);
