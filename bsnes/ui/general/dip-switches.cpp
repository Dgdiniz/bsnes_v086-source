...
DipSwitch::DipSwitch() {
  append(name,  { static_cast<unsigned int>(~0), 0 }, 5);
  append(value, { static_cast<unsigned int>(~0), 0 }, 0);
}
...
DipSwitches::DipSwitches() {
  ...
  layout.append(dip[n],                { static_cast<unsigned int>(~0), 0 }, 5);
  layout.append(controlLayout,         { static_cast<unsigned int>(~0), 0 }, 5);
