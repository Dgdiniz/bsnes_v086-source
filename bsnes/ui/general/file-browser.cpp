...
FileBrowser::FileBrowser() {
  ...
  append(layout);
    layout.append(pathLayout, { static_cast<unsigned int>(~0), 0 }, 5);
      pathLayout.append(pathEdit, { static_cast<unsigned int>(~0), 0 }, 5);
      pathLayout.append(pathBrowse, { 0, 0 }, 5);
      pathLayout.append(pathUp, { 0, 0 });
    layout.append(fileList, { static_cast<unsigned int>(~0), static_cast<unsigned int>(~0) }, 5);
    layout.append(controlLayout, { static_cast<unsigned int>(~0), 0 });
      controlLayout.append(filterLabel, { static_cast<unsigned int>(~0), 0 }, 5);
