...
AudioSettings::AudioSettings() {
  ...
  append(outputLabel,                     { static_cast<unsigned int>(~0), 0 }, 0);
  append(outputLayout,                    { static_cast<unsigned int>(~0), 0 }, 5);
  outputLayout.append(frequencyLabel,     {  0, 0 }, 5);
  outputLayout.append(frequencySelection, { static_cast<unsigned int>(~0), 0 }, 5);
  outputLayout.append(latencyLabel,       {  0, 0 }, 5);
  outputLayout.append(latencySelection,   { static_cast<unsigned int>(~0), 0 }, 5);
  outputLayout.append(resamplerLabel,     {  0, 0 }, 5);
  outputLayout.append(resamplerSelection, { static_cast<unsigned int>(~0), 0 }, 0);
  append(volume,                          { static_cast<unsigned int>(~0), 0 }, 5);
  append(frequencyAdjustmentLabel,        { static_cast<unsigned int>(~0), 0 }, 0);
  append(nes,                             { static_cast<unsigned int>(~0), 0 }, 0);
  append(snes,                            { static_cast<unsigned int>(~0), 0 }, 0);
  append(gameBoy,                         { static_cast<unsigned int>(~0), 0 }, 0);
