...
InputSettings::InputSettings() : activeInput(0) {
  ...
  append(selectionLayout,                 {  static_cast<unsigned int>(~0),  0 }, 5);
    selectionLayout.append(primary,       {  static_cast<unsigned int>(~0),  0 }, 5);
    selectionLayout.append(secondary,     {  static_cast<unsigned int>(~0),  0 }, 5);
    selectionLayout.append(tertiary,      {  static_cast<unsigned int>(~0),  0 }, 0);
  append(inputList,                       {  static_cast<unsigned int>(~0), static_cast<unsigned int>(~0) }, 5);
  append(controlLayout,                   {  static_cast<unsigned int>(~0),  0 }, 0);
    ...
    controlLayout.append(spacer,          {  static_cast<unsigned int>(~0),  0 }, 0);
