...
AdvancedSettings::AdvancedSettings() {
  ...
  append(driverLabel,                        { static_cast<unsigned int>(~0),  0 }, 0);
  append(driverLayout,                       { static_cast<unsigned int>(~0),  0 }, 5);
    driverLayout.append(videoLabel,          {  0,  0 }, 5);
    driverLayout.append(videoDriver,         { static_cast<unsigned int>(~0),  0 }, 5);
    driverLayout.append(audioLabel,          {  0,  0 }, 5);
    driverLayout.append(audioDriver,         { static_cast<unsigned int>(~0),  0 }, 5);
    driverLayout.append(inputLabel,          {  0,  0 }, 5);
    driverLayout.append(inputDriver,         { static_cast<unsigned int>(~0),  0 }, 0);
  append(focusPolicyLabel,                   { static_cast<unsigned int>(~0),  0 }, 0);
  append(focusPolicyLayout,                  { static_cast<unsigned int>(~0),  0 }, 5);
    focusPolicyLayout.append(focusPolicy[0], { static_cast<unsigned int>(~0),  0 }, 5);
    focusPolicyLayout.append(focusPolicy[1], { static_cast<unsigned int>(~0),  0 }, 5);
    focusPolicyLayout.append(focusPolicy[2], { static_cast<unsigned int>(~0),  0 }, 0);
  append(spacer,                             { static_cast<unsigned int>(~0), static_cast<unsigned int>(~0) }, 0);
  append(aboutLabel,                         { static_cast<unsigned int>(~0),  0 }, 0);
