...
SettingsLayout::SettingsLayout() {
  setMargin(5);
  HorizontalLayout::append(spacer, { 120, static_cast<unsigned int>(~0) }, 5);
  HorizontalLayout::append(layout, {  static_cast<unsigned int>(~0), static_cast<unsigned int>(~0) }, 0);
}
...
SettingsWindow::SettingsWindow() {
  ...
  append(layout);
    layout.append(panelList, { 120, static_cast<unsigned int>(~0) }, 5);
